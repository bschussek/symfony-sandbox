...
/**
 * @orm:Entity(repositoryClass="Liip\BlogBundle\Entity\PostRepository")
...
class Post
{
     ...
     * @validation:NotNull
     */
    protected $commentsDefaultStatus = Comment::STATUS_VALID;

    /**
     * @orm:ManyToOne(targetEntity="Author")
     * @validation:AssertType("Liip\BlogBundle\Entity\Author")
     */
    protected $author;
     ...
     * Add comments
     *
     * @param Liip\BlogBundle\Entity\Comment $comments
     */
    public function addComments(\Liip\BlogBundle\Entity\Comment $comments)
    {
     ...
     * Add tags
     *
     * @param Liip\BlogBundle\Entity\Tag $tags
     */
    public function addTags(\Liip\BlogBundle\Entity\Tag $tags)
    {
        $this->tags[] = $tags;
    }
